  ...
  return (
    <div className="min-h-screen bg-[#09090B] flex items-center justify-center p-6 dot-grid">
      <div className="w-full max-w-md bg-zinc-950 border border-zinc-800 p-8">
        ...
        <h1 className="font-chivo text-3xl font-black tracking-tighter mb-1">Sign in</h1>
        <p className="text-xs font-mono text-zinc-500 tracking-wider uppercase mb-8">
          Access your design vault
        </p>
        ...
        <form onSubmit={submit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-black border border-zinc-800 px-3 py-2.5 text-sm focus:border-white focus:outline-none transition-colors font-mono"
        ...
        <p className="text-xs font-mono text-zinc-500 mt-6 text-center">
          No account?{" "}
          <Link to="/register" data-testid="goto-register" className="text-white hover:underline">
            Create one
          </Link>
        </p>
      </div>
